/**
 * One-time scaffolding script used during initial project setup to
 * generate placeholder page components for every route in the app.
 * Existing files are never overwritten, so it is safe to keep around
 * but it is not part of the runtime build.
 *
